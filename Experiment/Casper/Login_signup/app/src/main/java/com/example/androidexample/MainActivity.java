...
public class MainActivity extends AppCompatActivity {
    ...
    private Button logoutButton; // define signup button variable
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logoutButton = findViewById(R.id.main_logout_btn);// link to signup button in the Main activity XML
