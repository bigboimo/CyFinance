...
public class TestController {
    ...
    @Autowired
    private com.mycompany.repository.CEORepository CEORepository;
    ...
    Message enterDummyData(){
        ...
        // Create and save CEO instances
        CEO ceo1 = new CEO("CEO 1");
        CEO ceo2 = new CEO("CEO 2");
        CEORepository.save(ceo1);
        CEORepository.save(ceo2);

        // Create company instances and associate them with CEOs
        Company companyA = new Company("CompanyA", "C1");
        companyA.setCeo(ceo1); // Associate company with CEO
        companyRepository.save(companyA);

        Company companyB = new Company("CompanyB", "C2");
        companyB.setCeo(ceo2); // Associate company with CEO
